...
assemble_manually () {
    ...
    INIT_HOOKS="\
    bash ${HOME}/.local/share/distrobox/helpers/shared/container_scripts/micro_setup.sh && \
    cp -f ${HOME}/.local/share/distrobox/helpers/shared/fish_prompt.fish /etc/fish/functions/"
